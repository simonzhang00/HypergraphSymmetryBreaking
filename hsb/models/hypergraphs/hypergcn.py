...
import hsb
from hsb.nn import HyperGCNConv
from hsb.structure.graphs import Graph
...
class HyperGCN(nn.Module):
    ...
    def __init__(
        ...
        self.layers.append(
            HyperGCNConv(
                hid_channels, hid_channels, use_mediator, use_bn=use_bn, drop_rate=drop_rate, is_last= True
            )
        )
        # self.layers.append(
        #     HyperGCNConv(
