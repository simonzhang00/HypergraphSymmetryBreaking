...
def make_train_test_data(dataset, prctl1 = 70, prctl2 = 85):
    ...
    hyperedges_df = pd.read_csv('../../hsb/data/processed-data/%s/%s-simplices.txt' % (dataset, dataset), names = ['hyperedge']).astype(str)
    ...
    return hyperedges_train, hyperedges_val, hyperedges_test
